...
# Zephyr Shell (첫 실행 약 10~15분 — 소스 500MB 다운로드) ⚠️ 미검증
./build.sh zephyr
./run.sh zephyr
...
| 타겟 | 설명 | 검증 |
|------|------|:----:|
| `zephyr` | Zephyr Shell 앱 빌드 | ⚠️ 미검증 |
...
| `zephyr` | Zephyr Shell (Cortex-M3) | ⚠️ 미검증 |
